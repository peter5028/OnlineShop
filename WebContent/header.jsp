...
<div class="topnav sticky">
 ...
 %> <i class='fas fa-user-alt'></i>
	...
	<a href="home.jsp">Home<i class="fa fa-institution"></i></a> <a
		...
		href="changeDetails.jsp">Change Details <i class="fa fa-edit"></i>
	</a> <a href="messageUs.jsp">Message Us <i class='fas fa-comment-alt'></i></a>
